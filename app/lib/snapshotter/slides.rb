...
module Snapshotter
  ...
  class Slides
    attr_reader :video_course, :app_host, :app_port, :snapshot_host, :snapshot_port

    def initialize(video_course:, app_host: 'app', app_port: 4567, snapshot_host: 'snapshot', snapshot_port: 3000)
    ...
    def generate
      ...
      video_course.parts.flat_map(&:episodes).each do |episode|
        ...
        browser.screenshot(path: "/data/src/slides/#{episode.slug}.png", selector: '#slide-to-snapshot')
      end
    end
